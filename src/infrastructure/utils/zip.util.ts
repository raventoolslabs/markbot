...
export class ZipUtil {
    ...
    private inlineImages(
        ...
        const processedImages = new Set<string>(); // Keep track of processed image paths to avoid duplicates
        ...
        currentMarkdown = currentMarkdown.replace(imageRegex, (match, altText, imagePath) => {
            ...
            if (imageEntry) {
                ...
                logger.warn(`Image file not found in ZIP: ${normalizedTarget} (resolved from ${markdownPath} + ${imagePath})`, 'ZipUtil');
                return match;
            }
        });
